...
const PricingCard = ({ title, price, features, description, id }: PricingCardProps) => {
  return (
    <div className={`${id === 2 && 'rounded-r-2xl border-l-0  '} ${id === 0 && 'rounded-l-2xl border-r-0'} ${id === 1 && 'rounded-t-2xl grow -mt-6 '}  text-gray-500 border  border-gray-300 p-8 w-96 flex flex-col gap-6 `}>
